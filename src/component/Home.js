...
const Home = ({id, owned, close, expires}) => {
...
function premio() {
    if (price === 1 && ring3 > 1) {
        return (
            <p className="priceInd">{"♥  You've won " + 5 + "$!"}</p>
        )
...
function numChecker(e) {
    ...
    return (
        ...
        <h1 className="casinoName">The CASINO</h1><br />
        <h1 className="price">{"Rewards " + jackpot + "$"}</h1>
        <div className="slot">
        <div className="row">
        {row1()}
        </div>
        ...
        {/* <h1 className="price">{"Available cash: " + (balance + 0.5) + "$"}</h1> */}
        <button onClick={() => setBalance(balance + 100)} className="buyMoreButton">Add 100 $</button><br /><br /><br /><br />

                    <p>© 2022Copyright:
                    <a href="/"> TheCasino.com</a></p>
        </div>
        <div>
